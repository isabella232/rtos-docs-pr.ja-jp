...
ms.locfileid: "116799372"
---
# <a name="appendix---port-specific-examples"></a>付録 - ポート固有の例

## <a name="arm11-processor"></a>ARM11 プロセッサ

### <a name="arm11-using-gcc"></a>GCC を使用した ARM11

#### <a name="module-preamble-for-arm11-using-gcc"></a>GCC を使用した ARM11 用モジュール プリアンブル
...
#### <a name="module-properties-for-arm11-using-gcc"></a>GCC を使用した ARM11 用モジュール プロパティ

| ビット | 値 | 説明 |
|---|---|---|
| [23-0] | 0 | 予約されています。
| [31-24] | <br />0x00<br />0x01<br />0x02 | **コンパイラ ID**<br />IAR<br />ARM<br />GNU |

#### <a name="module-linker-for-arm11-using-gcc"></a>GCC を使用した ARM11 用モジュール リンカー
...
#### <a name="building-modules-for-arm11-using-gcc"></a>GCC を使用した ARM11 用モジュールのビルド

GCC を使用して ARM11 モジュールをビルドする簡単なコマンド ラインの例を次に示します。
...
#### <a name="thread-extension-definition-for-arm11-using-gcc"></a>GCC を使用した ARM11 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-arm11-using-gcc"></a>GCC を使用した ARM11 用モジュール マネージャーのビルド

例は提供されていません。

#### <a name="attributes-for-external-memory-enable-api-for-arm11-using-gcc"></a>GCC を使用した ARM11 用外部メモリ有効化 API の属性

この機能はこのポートで有効になっていません。

### <a name="arm11-using-ac5"></a>AC5 を使用した ARM11

#### <a name="module-preamble-for-arm11-using-ac5"></a>AC5 を使用した ARM11 用モジュール プリアンブル
...
#### <a name="module-properties-for-arm11-using-ac5"></a>AC5 を使用した ARM11 用モジュール プロパティ
...
#### <a name="module-linker-for-arm11-using-ac5"></a>AC5 を使用した ARM11 用モジュール リンカー

コマンド ラインでビルドされます。リンカー ファイルの例はありません。

#### <a name="building-modules-for-arm11-using-ac5"></a>AC5 を使用した ARM11 用モジュールのビルド

AC5 を使用して ARM11 モジュールをビルドする簡単なコマンド ラインの例を次に示します。
...
#### <a name="thread-extension-definition-for-arm11-using-ac5"></a>AC5 を使用した ARM11 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-arm11-using-ac5"></a>AC5 を使用した ARM11 用モジュール マネージャーのビルド

AC5 を使用して ARM11 モジュール マネージャーをビルドする簡単なコマンド ラインの例を次に示します。
...
#### <a name="attributes-for-external-memory-enable-api-for-arm11-using-ac5"></a>AC5 を使用した ARM11 用外部メモリ有効化 API の属性

この機能はこのポートで有効になっていません。

## <a name="cortex-a7-processor"></a>Cortex-A7 プロセッサ

### <a name="cortex-a7-using-ac5"></a>AC5 を使用した Cortex-A7

#### <a name="module-preamble-for-cortex-a7-using-ac5"></a>AC5 を使用した Cortex-A7 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-a7-using-ac5"></a>AC5 を使用した Cortex-A7 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-a7-using-ac5"></a>AC5 を使用した Cortex-A7 用モジュール リンカー

コマンド ラインでビルドされます。リンカー ファイルの例はありません。

#### <a name="building-modules-for-cortex-a7-using-ac5"></a>AC5 を使用した Cortex-A7 用モジュールのビルド

AC5 を使用して Cortex-A7 モジュールをビルドする簡単なコマンド ラインの例を次に示します。
...
#### <a name="thread-extension-definition-for-cortex-a7-using-ac5"></a>AC5 を使用した Cortex-A7 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-a7-using-ac5"></a>AC5 を使用した Cortex-A7 用モジュール マネージャーのビルド

AC5 を使用して Cortex-A7 モジュール マネージャーをビルドする簡単なコマンド ラインの例を次に示します。
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-a7-using-ac5"></a>AC5 を使用した Cortex-A7 用外部メモリ有効化 API の属性

次の属性を使用して、共有メモリ設定をセットアップできます。

| 属性パラメーター | 説明 |
|---|---|
| TXM_MMU_ATTRIBUTE_XN | 実行しない |
| TXM_MMU_ATTRIBUTE_B | B 設定 |
| TXM_MMU_ATTRIBUTE_C | C 設定 |
| TXM_MMU_ATTRIBUTE_AP | AP 設定 |
| TXM_MMU_ATTRIBUTE_TEX | TEX 設定 |

これらの設定の構成方法については、ARM のドキュメントをご覧ください。

## <a name="cortex-m3-processor"></a>Cortex-M3 プロセッサ

### <a name="cortex-m3-using-ac5"></a>AC5 を使用した Cortex-M3

#### <a name="module-preamble-for-cortex-m3-using-ac5"></a>AC5 を使用した Cortex-M3 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m3-using-ac5"></a>AC5 を使用した Cortex-M3 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m3-using-ac5"></a>AC5 を使用した Cortex-M3 用モジュール リンカー

リンカー ファイルの例はまだ提供されていません。リンク設定はコマンド ラインで実行されます。 次のセクションをご覧ください。

#### <a name="building-modules-for-cortex-m3-using-ac5"></a>AC5 を使用した Cortex-M3 用モジュールのビルド
...
#### <a name="thread-extension-definition-for-cortex-m3-using-ac5"></a>AC5 を使用した Cortex-M3 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m3-using-ac5"></a>AC5 を使用した Cortex-M3 用モジュール マネージャーのビルド

build_threadx_module_manager_demo.bat の例を以下に示します。
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-ac5"></a>AC5 を使用した Cortex-M3 用外部メモリ有効化 API の属性

モジュールは常に共有メモリへの読み取りアクセスが可能です。

| 属性パラメーター | 説明 |
|---|---|
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_WRITE | 書き込みアクセス |

### <a name="cortex-m3-using-ac6"></a>AC6 を使用した Cortex-M3

#### <a name="module-preamble-for-cortex-m3-using-ac6"></a>AC6 を使用した Cortex-M3 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m3-using-ac6"></a>AC6 を使用した Cortex-M3 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m3-using-ac6"></a>AC6 を使用した Cortex-M3 用モジュール リンカー

リンカー ファイルが使用されていません。 プロジェクトの設定をご覧ください。

#### <a name="building-modules-for-cortex-m3-using-ac6"></a>AC6 を使用した Cortex-M3 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、サンプル モジュール プロジェクト、およびサンプル モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-cortex-m3-using-ac6"></a>AC6 を使用した Cortex-M3 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m3-using-ac6"></a>AC6 を使用した Cortex-M3 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、サンプル モジュール プロジェクト、およびサンプル モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-ac6"></a>AC6 を使用した Cortex-M3 用外部メモリ有効化 API の属性
...
### <a name="cortex-m3-using-gnu"></a>GNU を使用した Cortex-M3

#### <a name="module-preamble-for-cortex-m3-using-gnu"></a>GNU を使用した Cortex-M3 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m3-using-gnu"></a>GNU を使用した Cortex-M3 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m3-using-gnu"></a>GNU を使用した Cortex-M3 用モジュール リンカー
...
#### <a name="building-modules-for-cortex-m3-using-gnu"></a>GNU を使用した Cortex-M3 用モジュールのビルド

build_threadx_module_sample.bat を以下に示します。
...
#### <a name="thread-extension-definition-for-cortex-m3-using-gnu"></a>GNU を使用した Cortex-M3 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m3-using-gnu"></a>GNU を使用した Cortex-M3 用モジュール マネージャーのビルド

build_threadx_module_manager_sample.bat を以下に示します。
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-gnu"></a>GNU を使用した Cortex-M3 用外部メモリ有効化 API の属性
...
### <a name="cortex-m3-using-iar"></a>IAR を使用した Cortex-M3

#### <a name="module-preamble-for-cortex-m3-using-iar"></a>IAR を使用した Cortex-M3 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m3-using-iar"></a>IAR を使用した Cortex-M3 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m3-using-iar"></a>IAR を使用した Cortex-M3 用モジュール リンカー
...
#### <a name="building-modules-for-cortex-m3-using-iar"></a>IAR を使用した Cortex-M3 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-cortex-m3-using-iar"></a>IAR を使用した Cortex-M3 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m3-using-iar"></a>IAR を使用した Cortex-M3 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-iar"></a>IAR を使用した Cortex-M3 用外部メモリ有効化 API の属性
...
## <a name="cortex-m33-processor"></a>Cortex-M33 プロセッサ

### <a name="cortex-m33-using-ac6"></a>AC6 を使用した Cortex-M33

#### <a name="module-preamble-for-cortex-m33-using-ac6"></a>AC6 を使用した Cortex-M33 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m33-using-ac6"></a>AC6 を使用した Cortex-M33 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m33-using-ac6"></a>AC6 を使用した Cortex-M33 用モジュール リンカー

Keil ツールチェーンに必要なリンカー ファイルがありません。 サンプル プロジェクト内のビルド設定をご覧ください。
重要なリンカー オプションを以下に示します。

```c
--entry demo_module_start --first __txm_module_preamble
```

#### <a name="building-modules-for-cortex-m33-using-ac6"></a>AC6 を使用した Cortex-M33 用モジュールのビルド
...
#### <a name="thread-extension-definition-for-cortex-m33-using-ac6"></a>AC6 を使用した Cortex-M33 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m33-using-ac6"></a>AC6 を使用した Cortex-M33 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、sample_threadx_module プロジェクト、および demo_threadx_non-secure_zone プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-ac6"></a>AC6 を使用した Cortex-M33 用外部メモリ有効化 API の属性
...
### <a name="cortex-m33-using-gnu"></a>GNU を使用した Cortex-M33

#### <a name="module-preamble-for-cortex-m33-using-gnu"></a>GNU を使用した Cortex-M33 用モジュール プリアンブル

#### <a name="module-properties-for-cortex-m33-using-gnu"></a>GNU を使用した Cortex-M33 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m33-using-gnu"></a>GNU を使用した Cortex-M33 用モジュール リンカー

#### <a name="building-modules-for-cortex-m33-using-gnu"></a>GNU を使用した Cortex-M33 用モジュールのビルド

#### <a name="thread-extension-definition-for-cortex-m33-using-gnu"></a>GNU を使用した Cortex-M33 用スレッド拡張機能の定義

#### <a name="building-module-manager-for-cortex-m33-using-gnu"></a>GNU を使用した Cortex-M33 用モジュール マネージャーのビルド

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-gnu"></a>GNU を使用した Cortex-M33 用外部メモリ有効化 API の属性
...
### <a name="cortex-m33-using-iar"></a>IAR を使用した Cortex-M33

#### <a name="module-preamble-for-cortex-m33-using-iar"></a>IAR を使用した Cortex-M33 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m33-using-iar"></a>IAR を使用した Cortex-M33 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m33-using-iar"></a>IAR を使用した Cortex-M33 用モジュール リンカー
...
#### <a name="building-modules-for-cortex-m33-using-iar"></a>IAR を使用した Cortex-M33 用モジュールのビルド

#### <a name="thread-extension-definition-for-cortex-m33-using-iar"></a>IAR を使用した Cortex-M33 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m33-using-iar"></a>IAR を使用した Cortex-M33 用モジュール マネージャーのビルド

ワークスペースの例はまだ提供されていません。 近日対応予定。

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-iar"></a>IAR を使用した Cortex-M33 用外部メモリ有効化 API の属性
...
## <a name="cortex-m4-processor"></a>Cortex-M4 プロセッサ

### <a name="cortex-m4-using-ac5"></a>AC5 を使用した Cortex-M4

#### <a name="module-preamble-for-cortex-m4-using-ac5"></a>AC5 を使用した Cortex-M4 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m4-using-ac5"></a>AC5 を使用した Cortex-M4 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m4-using-ac5"></a>AC5 を使用した Cortex-M4 用モジュール リンカー

リンカー ファイルの例はまだ提供されていません。リンク設定はコマンド ラインで実行されます。 次のセクションをご覧ください。

#### <a name="building-modules-for-cortex-m4-using-ac5"></a>AC5 を使用した Cortex-M4 用モジュールのビルド

build_threadx_module_demo.bat の例を以下に示します。
...
#### <a name="thread-extension-definition-for-cortex-m4-using-ac5"></a>AC5 を使用した Cortex-M4 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m4-using-ac5"></a>AC5 を使用した Cortex-M4 用モジュール マネージャーのビルド
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-ac5"></a>AC5 を使用した Cortex-M4 用外部メモリ有効化 API の属性
...
### <a name="cortex-m4-using-ac6"></a>AC6 を使用した Cortex-M4

#### <a name="module-preamble-for-cortex-m4-using-ac6"></a>AC6 を使用した Cortex-M4 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m4-using-ac6"></a>AC6 を使用した Cortex-M4 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m4-using-ac6"></a>AC6 を使用した Cortex-M4 用モジュール リンカー

リンカー ファイルが使用されていません。 プロジェクトの設定をご覧ください。

#### <a name="building-modules-for-cortex-m4-using-ac6"></a>AC6 を使用した Cortex-M4 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、サンプル モジュール プロジェクト、およびサンプル モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-cortex-m4-using-ac6"></a>AC6 を使用した Cortex-M4 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m4-using-ac6"></a>AC6 を使用した Cortex-M4 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、サンプル モジュール プロジェクト、およびサンプル モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-ac6"></a>AC6 を使用した Cortex-M4 用外部メモリ有効化 API の属性
...
### <a name="cortex-m4-using-gnu"></a>GNU を使用した Cortex-M4

#### <a name="module-preamble-for-cortex-m4-using-gnu"></a>GNU を使用した Cortex-M4 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m4-using-gnu"></a>GNU を使用した Cortex-M4 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m4-using-gnu"></a>GNU を使用した Cortex-M4 用モジュール リンカー
...
#### <a name="building-modules-for-cortex-m4-using-gnu"></a>GNU を使用した Cortex-M4 用モジュールのビルド
...
#### <a name="thread-extension-definition-for-cortex-m4-using-gnu"></a>GNU を使用した Cortex-M4 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m4-using-gnu"></a>GNU を使用した Cortex-M4 用モジュール マネージャーのビルド
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-gnu"></a>GNU を使用した Cortex-M4 用外部メモリ有効化 API の属性
...
### <a name="cortex-m4-using-iar"></a>IAR を使用した Cortex-M4

#### <a name="module-preamble-for-cortex-m4-using-iar"></a>IAR を使用した Cortex-M4 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m4-using-iar"></a>IAR を使用した Cortex-M4 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m4-using-iar"></a>IAR を使用した Cortex-M4 用モジュール リンカー
...
#### <a name="building-modules-for-cortex-m4-using-iar"></a>IAR を使用した Cortex-M4 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-cortex-m4-using-iar"></a>IAR を使用した Cortex-M4 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m4-using-iar"></a>IAR を使用した Cortex-M4 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-iar"></a>IAR を使用した Cortex-M4 用外部メモリ有効化 API の属性
...
## <a name="cortex-m7-processor"></a>Cortex-M7 プロセッサ

### <a name="cortex-m7-using-ac5"></a>AC5 を使用した Cortex-M7

#### <a name="module-preamble-for-cortex-m7-using-ac5"></a>AC5 を使用した Cortex-M7 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m7-using-ac5"></a>AC5 を使用した Cortex-M7 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m7-using-ac5"></a>AC5 を使用した Cortex-M7 用モジュール リンカー

コマンド ラインでビルドされます。リンカー ファイルの例はありません。

#### <a name="building-modules-for-cortex-m7-using-ac5"></a>AC5 を使用した Cortex-M7 用モジュールのビルド

AC5 を使用して Cortex-M7 モジュールをビルドする簡単なコマンド ラインの例を次に示します。
...
#### <a name="thread-extension-definition-for-cortex-m7-using-ac5"></a>AC5 を使用した Cortex-M7 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m7-using-ac5"></a>AC5 を使用した Cortex-M7 用モジュール マネージャーのビルド

AC5 を使用して Cortex-M7 モジュール マネージャーをビルドする簡単なコマンド ラインの例を次に示します。
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-ac5"></a>AC5 を使用した Cortex-M7 用外部メモリ有効化 API の属性

### <a name="cortex-m7-using-ac6"></a>AC6 を使用した Cortex-M7

#### <a name="module-properties-for-cortex-m7-using-ac6"></a>AC6 を使用した Cortex-M7 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m7-using-ac6"></a>AC6 を使用した Cortex-M7 用モジュール リンカー

リンカー ファイルが使用されていません。 プロジェクトの設定をご覧ください。

#### <a name="building-modules-for-cortex-m7-using-ac6"></a>AC6 を使用した Cortex-M7 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、サンプル モジュール プロジェクト、およびサンプル モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-cortex-m7-using-ac6"></a>AC6 を使用した Cortex-M7 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m7-using-ac6"></a>AC6 を使用した Cortex-M7 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、サンプル モジュール プロジェクト、およびサンプル モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-ac6"></a>AC6 を使用した Cortex-M7 用外部メモリ有効化 API の属性
...
### <a name="cortex-m7-using-gnu"></a>GNU を使用した Cortex-M7

#### <a name="module-properties-for-cortex-m7-using-gnu"></a>GNU を使用した Cortex-M7 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m7-using-gnu"></a>GNU を使用した Cortex-M7 用モジュール リンカー
...
#### <a name="building-modules-for-cortex-m7-using-gnu"></a>GNU を使用した Cortex-M7 用モジュールのビルド
...
#### <a name="thread-extension-definition-for-cortex-m7-using-gnu"></a>GNU を使用した Cortex-M7 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m7-using-gnu"></a>GNU を使用した Cortex-M7 用モジュール マネージャーのビルド
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-gnu"></a>GNU を使用した Cortex-M7 用外部メモリ有効化 API の属性
...
### <a name="cortex-m7-using-iar"></a>IAR を使用した Cortex-M7

#### <a name="module-preamble-for-cortex-m7-using-iar"></a>IAR を使用した Cortex-M7 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-m7-using-iar"></a>IAR を使用した Cortex-M7 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-m7-using-iar"></a>IAR を使用した Cortex-M7 用モジュール リンカー
...
#### <a name="building-modules-for-cortex-m7-using-iar"></a>IAR を使用した Cortex-M7 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-cortex-m7-using-iar"></a>IAR を使用した Cortex-M7 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-m7-using-iar"></a>IAR を使用した Cortex-M7 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-iar"></a>IAR を使用した Cortex-M7 用外部メモリ有効化 API の属性
...
## <a name="cortex-r4-processor"></a>Cortex-R4 プロセッサ

### <a name="cortex-r4-using-ac6"></a>AC6 を使用した Cortex-R4

#### <a name="module-preamble-for-cortex-r4-using-ac6"></a>AC6 を使用した Cortex-R4 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-r4-using-ac6"></a>AC6 を使用した Cortex-R4 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-r4-using-ac6"></a>AC6 を使用した Cortex-R4 用モジュール リンカー

コマンド ラインでビルドされます。リンカー ファイルの例はありません。

#### <a name="building-modules-for-cortex-r4-using-ac6"></a>AC6 を使用した Cortex-R4 用モジュールのビルド

AC6 を使用して Cortex-R4 モジュールをビルドする簡単なコマンド ラインの例を次に示します。
...
#### <a name="thread-extension-definition-for-cortex-r4-using-ac6"></a>AC6 を使用した Cortex-R4 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-r4-using-ac6"></a>AC6 を使用した Cortex-R4 用モジュール マネージャーのビルド

AC6 を使用して Cortex-R4 モジュール マネージャーをビルドする簡単なコマンド ラインの例を次に示します。
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-r4-using-ac6"></a>AC6 を使用した Cortex-R4 用外部メモリ有効化 API の属性
...
### <a name="cortex-r4-using-iar"></a>IAR を使用した Cortex-R4

#### <a name="module-preamble-for-cortex-r4-using-iar"></a>IAR を使用した Cortex-R4 用モジュール プリアンブル
...
#### <a name="module-properties-for-cortex-r4-using-iar"></a>IAR を使用した Cortex-R4 用モジュール プロパティ
...
#### <a name="module-linker-for-cortex-r4-using-iar"></a>IAR を使用した Cortex-R4 用モジュール リンカー
...
#### <a name="building-modules-for-cortex-r4-using-iar"></a>IAR を使用した Cortex-R4 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-cortex-r4-using-iar"></a>IAR を使用した Cortex-R4 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-cortex-r4-using-iar"></a>IAR を使用した Cortex-R4 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-cortex-r4-using-iar"></a>IAR を使用した Cortex-R4 用外部メモリ有効化 API の属性
...
## <a name="mcf544xx-processor"></a>MCF544xx プロセッサ

### <a name="mcf544xx-using-ghs"></a>GHS を使用した MCF544xx

#### <a name="module-preamble-for-mcf544xx-using-ghs"></a>GHS を使用した MCF544xx 用モジュール プリアンブル
...
#### <a name="module-properties-for-mcf544xx-using-ghs"></a>GHS を使用した MCF544xx 用モジュール プロパティ

| ビット | 値 | 意味 |
|---|---|---|
| 0 | 0<br />1 | 特権モード実行<br />ユーザー モード実行 |
| 1 | 0<br />1 | MMU 保護なし<br />MMU 保護 (ユーザー モードが選択されている必要があります) |
| 2 | 0<br />1 | 共有/外部メモリ アクセスを無効にする<br />共有/外部メモリ アクセスを有効にする |
| [23-3] | 0 | 予約されています。
| [31-24] | <br />0x03 | **コンパイラ ID**<br />GHS |

#### <a name="module-linker-for-mcf544xx-using-ghs"></a>GHS を使用した MCF544xx 用モジュール リンカー
...
#### <a name="building-modules-for-mcf544xx-using-ghs"></a>GHS を使用した MCF544xx 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-mcf544xx-using-ghs"></a>GHS を使用した MCF544xx 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-mcf544xx-using-ghs"></a>GHS を使用した MCF544xx 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-mcf544xx-using-ghs"></a>GHS を使用した MCF544xx 用外部メモリ有効化 API の属性

この機能は MCF544xx で有効になっていません。

## <a name="rx63-processor"></a>RX63 プロセッサ

### <a name="rx63-using-iar"></a>IAR を使用した RX63

#### <a name="module-preamble-for-rx63-using-iar"></a>IAR を使用した RX63 用モジュール プリアンブル
...
#### <a name="module-properties-for-rx63-using-iar"></a>IAR を使用した RX63 用モジュール プロパティ
...
| 2 | 0<br />1 | 共有/外部メモリ アクセスを無効にする<br />共有/外部メモリ アクセスを有効にする |
| [23-3] | 0 | 予約されています。
| [31-24] | <br />0x00<br />0x02 | **コンパイラ ID**<br />IAR<br />GNU |

#### <a name="module-linker-for-rx63-using-iar"></a>IAR を使用した RX63 用モジュール リンカー
...
#### <a name="building-modules-for-rx63-using-iar"></a>IAR を使用した RX63 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-rxrx635n-using-iar"></a>IAR を使用した RXRX635N 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-rx63-using-iar"></a>IAR を使用した RX63 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-rx63-using-iar"></a>IAR を使用した RX63 用外部メモリ有効化 API の属性

| 属性パラメーター | 説明 |
|---|---|
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_EXECUTE | コードを実行する |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_WRITE | 書き込みアクセス |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_READ | 読み取りアクセス |

## <a name="rx65n-processor"></a>RX65N プロセッサ

### <a name="rx65n-using-iar"></a>IAR を使用した RX65N

#### <a name="module-preamble-for-rx65n-using-iar"></a>IAR を使用した RX65N 用モジュール プリアンブル
...
#### <a name="module-properties-for-rx65n-using-iar"></a>IAR を使用した RX65N 用モジュール プロパティ
...
#### <a name="module-linker-for-rx65n-using-iar"></a>IAR を使用した RX65N 用モジュール リンカー
...
#### <a name="building-modules-for-rx65n-using-iar"></a>IAR を使用した RX65N 用モジュールのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="thread-extension-definition-for-rx65n-using-iar"></a>IAR を使用した RX65N 用スレッド拡張機能の定義
...
#### <a name="building-module-manager-for-rx65n-using-iar"></a>IAR を使用した RX65N 用モジュール マネージャーのビルド

ワークスペースの例が提供されています。 ThreadX ライブラリ、ThreadX モジュール ライブラリ、デモ モジュール プロジェクト、およびデモ モジュール マネージャー プロジェクトをビルドします。

#### <a name="attributes-for-external-memory-enable-api-for-rx65n-using-iar"></a>IAR を使用した RX65N 用外部メモリ有効化 API の属性
