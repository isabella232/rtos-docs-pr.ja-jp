...
ms.locfileid: "116790141"
---
# <a name="appendix-a---azure-rtos-netx-duo-services"></a>付録 A - Azure RTOS NetX Duo のサービス

## <a name="address-resolution-protocol-arp"></a>アドレス解決プロトコル (ARP)  
...
UINT     nx_igmp_multicast_leave(NX_IP *ip_ptr,
            ULONG group_address);
```
## <a name="internet-protocol-ip"></a>インターネット プロトコル (IP)●いんたーねっとぷろとこる(ip)○ 
...
## <a name="packet-management"></a>パケット管理  
...
## <a name="reverse-address-resolution-protocol-rarp"></a>逆アドレス解決プロトコル (RARP)  
