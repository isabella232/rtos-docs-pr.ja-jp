---
title: 付録 A - Azure RTOS NetX Duo のサービス
description: Azure RTOS NetX Duo サービスについて説明します。
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104811864"
---
# <a name="appendix-a---azure-rtos-netx-duo-services"></a><span data-ttu-id="1c0a8-103">付録 A - Azure RTOS NetX Duo のサービス</span><span class="sxs-lookup"><span data-stu-id="1c0a8-103">Appendix A - Azure RTOS NetX Duo Services</span></span>

## <a name="address-resolution-protocol-arp"></a><span data-ttu-id="1c0a8-104">アドレス解決プロトコル (ARP)</span><span class="sxs-lookup"><span data-stu-id="1c0a8-104">Address Resolution Protocol (ARP)</span></span>  
...
## <a name="internet-control-message-protocol-icmp"></a><span data-ttu-id="1c0a8-105">インターネット制御メッセージ プロトコル (ICMP)</span><span class="sxs-lookup"><span data-stu-id="1c0a8-105">Internet Control Message Protocol (ICMP)</span></span>  
...
## <a name="internet-group-management-protocol-igmp"></a><span data-ttu-id="1c0a8-106">インターネット グループ管理プロトコル (IGMP)</span><span class="sxs-lookup"><span data-stu-id="1c0a8-106">Internet Group Management Protocol (IGMP)</span></span>  
...
UINT     nx_igmp_multicast_leave(NX_IP *ip_ptr,
            ULONG group_address);
```
## <a name="internet-protocol-ip"></a><span data-ttu-id="1c0a8-107">インターネット プロトコル (IP)●いんたーねっとぷろとこる(ip)○</span><span class="sxs-lookup"><span data-stu-id="1c0a8-107">Internet Protocol (IP)</span></span> 
...
## <a name="neighbor-discovery"></a><span data-ttu-id="1c0a8-108">近隣探索</span><span class="sxs-lookup"><span data-stu-id="1c0a8-108">Neighbor Discovery</span></span>  
...
## <a name="packet-management"></a><span data-ttu-id="1c0a8-109">パケット管理</span><span class="sxs-lookup"><span data-stu-id="1c0a8-109">Packet Management</span></span>  
...
## <a name="reverse-address-resolution-protocol-rarp"></a><span data-ttu-id="1c0a8-110">逆アドレス解決プロトコル (RARP)</span><span class="sxs-lookup"><span data-stu-id="1c0a8-110">Reverse Address Resolution Protocol (RARP)</span></span>  
...
## <a name="system-management"></a><span data-ttu-id="1c0a8-111">システム管理</span><span class="sxs-lookup"><span data-stu-id="1c0a8-111">System Management</span></span>  

```c
VOID     nx_system_initialize(VOID);
```

## <a name="transmission-control-protocol-tcp"></a><span data-ttu-id="1c0a8-112">伝送制御プロトコル (TCP)</span><span class="sxs-lookup"><span data-stu-id="1c0a8-112">Transmission Control Protocol (TCP)</span></span>  
...
## <a name="user-datagram-protocol-udp"></a><span data-ttu-id="1c0a8-113">ユーザー データグラム プロトコル (UDP)</span><span class="sxs-lookup"><span data-stu-id="1c0a8-113">User Datagram Protocol (UDP)</span></span>  
