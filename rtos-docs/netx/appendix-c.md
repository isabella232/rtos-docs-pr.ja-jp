---
title: 別表 C - Azure RTOS NetX のデータ型
description: Azure RTOS NetX のデータ型について説明します。
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104810466"
---
# <a name="appendix-c---azure-rtos-netx-data-types"></a><span data-ttu-id="63608-103">別表 C - Azure RTOS NetX のデータ型</span><span class="sxs-lookup"><span data-stu-id="63608-103">Appendix C - Azure RTOS NetX Data Types</span></span>

## <a name="nx_arp"></a><span data-ttu-id="63608-104">NX_ARP</span><span class="sxs-lookup"><span data-stu-id="63608-104">NX_ARP</span></span>
...
## <a name="nx_interface"></a><span data-ttu-id="63608-105">NX_INTERFACE</span><span class="sxs-lookup"><span data-stu-id="63608-105">NX_INTERFACE</span></span>
...
##  <a name="nx_ip"></a><span data-ttu-id="63608-106">NX_IP</span><span class="sxs-lookup"><span data-stu-id="63608-106">NX_IP</span></span>
...
##  <a name="nx_ip_driver"></a><span data-ttu-id="63608-107">NX_IP_DRIVER</span><span class="sxs-lookup"><span data-stu-id="63608-107">NX_IP_DRIVER</span></span>
...
## <a name="nx_ip_routing_entry"></a><span data-ttu-id="63608-108">NX_IP_ROUTING_ENTRY</span><span class="sxs-lookup"><span data-stu-id="63608-108">NX_IP_ROUTING_ENTRY</span></span>
...
## <a name="nx_packet"></a><span data-ttu-id="63608-109">NX_PACKET</span><span class="sxs-lookup"><span data-stu-id="63608-109">NX_PACKET</span></span>
...
## <a name="nx_packet_pool"></a><span data-ttu-id="63608-110">NX_PACKET_POOL</span><span class="sxs-lookup"><span data-stu-id="63608-110">NX_PACKET_POOL</span></span>
...
## <a name="nx_tcp_listen"></a><span data-ttu-id="63608-111">NX_TCP_LISTEN</span><span class="sxs-lookup"><span data-stu-id="63608-111">NX_TCP_LISTEN</span></span>
...
## <a name="nx_tcp_socket"></a><span data-ttu-id="63608-112">NX_TCP_SOCKET;</span><span class="sxs-lookup"><span data-stu-id="63608-112">NX_TCP_SOCKET;</span></span>
...
## <a name="nx_udp_socket"></a><span data-ttu-id="63608-113">NX_UDP_SOCKET</span><span class="sxs-lookup"><span data-stu-id="63608-113">NX_UDP_SOCKET</span></span>
