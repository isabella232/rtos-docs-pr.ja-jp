...
ms.locfileid: "116796873"
---
# <a name="chapter-3---description-of-azure-rtos-netx-autoip-services"></a>第 3 章 - Azure RTOS NetX AutoIP サービスの説明

この章では、すべての Azure RTOS NetX AutoIP サービス (以下に記載) をアルファベット順に説明します。
...
- **NX_AUTO_IP_BAD_INTERFACE_INDEX**: (0xA02) ネットワーク インターフェイスが無効です。 
- NX_PTR_ERROR: (0x16) AutoIP ポインターが無効です。
- NX_CALLER_ERROR: (0x11) このサービスの呼び出し元が無効です。
