---
title: 第 3 章 - Azure RTOS NetX BSD サービス
description: この章では、すべての Azure RTOS NetX BSD 基本サービス (以下に記載) をアルファベット順に説明します。
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104810415"
---
# <a name="chapter-3---azure-rtos-netx-bsd-services"></a><span data-ttu-id="a3b30-103">第 3 章 - Azure RTOS NetX BSD サービス</span><span class="sxs-lookup"><span data-stu-id="a3b30-103">Chapter 3 - Azure RTOS NetX BSD Services</span></span>

<span data-ttu-id="a3b30-104">この章では、すべての Azure RTOS NetX BSD 基本サービス (以下に記載) をアルファベット順に説明します。</span><span class="sxs-lookup"><span data-stu-id="a3b30-104">This chapter contains a description of all Azure RTOS NetX BSD basic services listed below in alphabetic order.</span></span>
