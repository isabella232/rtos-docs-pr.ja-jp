---
title: 付録 A - Azure RTOS NetX サービス
description: Azure RTOS NetX サービスについて説明します。
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104810463"
---
# <a name="appendix-a---azure-rtos-netx-services"></a><span data-ttu-id="32fe9-103">付録 A - Azure RTOS NetX サービス</span><span class="sxs-lookup"><span data-stu-id="32fe9-103">Appendix A - Azure RTOS NetX Services</span></span>

## <a name="address-resolution-protocol-arp"></a><span data-ttu-id="32fe9-104">アドレス解決プロトコル (ARP)</span><span class="sxs-lookup"><span data-stu-id="32fe9-104">Address Resolution Protocol (ARP)</span></span>  
...
## <a name="internet-control-message-protocol-icmp"></a><span data-ttu-id="32fe9-105">インターネット制御メッセージ プロトコル (ICMP)</span><span class="sxs-lookup"><span data-stu-id="32fe9-105">Internet Control Message Protocol (ICMP)</span></span>  
...
## <a name="internet-group-management-protocol-igmp"></a><span data-ttu-id="32fe9-106">インターネット グループ管理プロトコル (IGMP)</span><span class="sxs-lookup"><span data-stu-id="32fe9-106">Internet Group Management Protocol (IGMP)</span></span>  
...
## <a name="internet-protocol-ip"></a><span data-ttu-id="32fe9-107">インターネット プロトコル (IP)●いんたーねっとぷろとこる(ip)○</span><span class="sxs-lookup"><span data-stu-id="32fe9-107">Internet Protocol (IP)</span></span>  
...
## <a name="packet-management"></a><span data-ttu-id="32fe9-108">パケット管理</span><span class="sxs-lookup"><span data-stu-id="32fe9-108">Packet Management</span></span>  
...
## <a name="reverse-address-resolution-protocol-rarp"></a><span data-ttu-id="32fe9-109">逆アドレス解決プロトコル (RARP)</span><span class="sxs-lookup"><span data-stu-id="32fe9-109">Reverse Address Resolution Protocol (RARP)</span></span>  
...
## <a name="system-management"></a><span data-ttu-id="32fe9-110">システム管理</span><span class="sxs-lookup"><span data-stu-id="32fe9-110">System Management</span></span>  

```c
VOID nx_system_initialize(VOID);
```

## <a name="transmission-control-protocol-tcp"></a><span data-ttu-id="32fe9-111">伝送制御プロトコル (TCP)</span><span class="sxs-lookup"><span data-stu-id="32fe9-111">Transmission Control Protocol (TCP)</span></span>  
...
## <a name="user-datagram-protocol-udp"></a><span data-ttu-id="32fe9-112">ユーザー データグラム プロトコル (UDP)</span><span class="sxs-lookup"><span data-stu-id="32fe9-112">User Datagram Protocol (UDP)</span></span>  
