...
ms.locfileid: "116786401"
---
# <a name="guix-example"></a>GUIX の例

GUIX のデモンストレーション システムは、examples/helloworld/helloworld.c で定義されている小さな例で提供されています。 この例では、GUIX システムを初期化してディスプレイ ドライバーを設定するために必要な手順が示されています。 以下のページにソース コードを示します。
