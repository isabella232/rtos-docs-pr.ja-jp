---
title: 付録 A - サンプル tx_port.h
description: この章には、サンプルの tx_port.h ファイルが記載されています。
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104812665"
---
# <a name="appendix-a---sample-tx_porth"></a><span data-ttu-id="3f9cc-103">付録 A - サンプル tx_port.h</span><span class="sxs-lookup"><span data-stu-id="3f9cc-103">Appendix A - Sample tx_port.h</span></span>

<span data-ttu-id="3f9cc-104">この章には、サンプルの **tx_port.h** ファイルが記載されています。</span><span class="sxs-lookup"><span data-stu-id="3f9cc-104">This chapter displays a sample **tx_port.h** file.</span></span>
