---
title: 付録 B - tx_trace.h ファイル
description: この章では、tx_trace.h ファイルを示します。
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104812644"
---
# <a name="appendix-b---the-tx_traceh-file"></a><span data-ttu-id="d1d83-103">付録 B - tx_trace.h ファイル</span><span class="sxs-lookup"><span data-stu-id="d1d83-103">Appendix B - The tx_trace.h file</span></span>

<span data-ttu-id="d1d83-104">この章では、**tx_trace.h** ファイルを示します。</span><span class="sxs-lookup"><span data-stu-id="d1d83-104">This chapter displays the **tx_trace.h** file.</span></span>
