...
ms.locfileid: "116783817"
---
# <a name="appendix-b---azure-rtos-filex-constants"></a>付録 B - Azure RTOS FileX の定数

## <a name="alphabeticlistings"></a>アルファベット順一覧 
...
## <a name="listings-by-value"></a>値順一覧
