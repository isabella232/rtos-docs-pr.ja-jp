---
title: 付録 C - Azure RTOS ThreadX のデータ型
description: Azure RTOS ThreadX のデータ型について説明します。
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
ms.locfileid: "104810280"
---
# <a name="appendix-c---azure-rtos-threadx-data-types"></a><span data-ttu-id="fb135-103">付録 C - Azure RTOS ThreadX のデータ型</span><span class="sxs-lookup"><span data-stu-id="fb135-103">Appendix C - Azure RTOS ThreadX Data Types</span></span>

## <a name="tx_block_pool"></a><span data-ttu-id="fb135-104">TX_BLOCK_POOL</span><span class="sxs-lookup"><span data-stu-id="fb135-104">TX_BLOCK_POOL</span></span>
...
## <a name="tx_byte_pool"></a><span data-ttu-id="fb135-105">TX_BYTE_POOL</span><span class="sxs-lookup"><span data-stu-id="fb135-105">TX_BYTE_POOL</span></span>
...
```
## <a name="tx_event_flags_group"></a><span data-ttu-id="fb135-106">TX_EVENT_FLAGS_GROUP</span><span class="sxs-lookup"><span data-stu-id="fb135-106">TX_EVENT_FLAGS_GROUP</span></span>
```c
...
## <a name="tx_mutex"></a><span data-ttu-id="fb135-107">TX_MUTEX</span><span class="sxs-lookup"><span data-stu-id="fb135-107">TX_MUTEX</span></span>
...
```
## <a name="tx_queue"></a><span data-ttu-id="fb135-108">TX_QUEUE</span><span class="sxs-lookup"><span data-stu-id="fb135-108">TX_QUEUE</span></span>
...
```
## <a name="tx_semaphore"></a><span data-ttu-id="fb135-109">TX_SEMAPHORE</span><span class="sxs-lookup"><span data-stu-id="fb135-109">TX_SEMAPHORE</span></span>
...
## <a name="tx_thread"></a><span data-ttu-id="fb135-110">TX_THREAD</span><span class="sxs-lookup"><span data-stu-id="fb135-110">TX_THREAD</span></span>
...
```
## <a name="tx_timer"></a><span data-ttu-id="fb135-111">TX_TIMER</span><span class="sxs-lookup"><span data-stu-id="fb135-111">TX_TIMER</span></span>
...
```
## <a name="tx_timer_internal"></a><span data-ttu-id="fb135-112">TX_TIMER_INTERNAL</span><span class="sxs-lookup"><span data-stu-id="fb135-112">TX_TIMER_INTERNAL</span></span>
