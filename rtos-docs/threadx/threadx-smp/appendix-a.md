...
ms.locfileid: "116798845"
---
# <a name="appendix-a---azure-rtos-threadx-smp-api-services"></a>付録 A - Azure RTOS ThreadX SMP API サービス

## <a name="entry-function"></a>エントリ関数

```C
VOID     tx_kernel_enter(VOID);
```
## <a name="block-memory-services"></a>ブロック メモリ サービス
...
```
## <a name="byte-memory-services"></a>バイト メモリ サービス
...
```
## <a name="event-flags-services"></a>イベント フラグ サービス
...
```
## <a name="mutex-services"></a>ミューテックス サービス
...
```
## <a name="queue-services"></a>キュー サービス
...
```
## <a name="semaphore-services"></a>セマフォ サービス
...
UINT     tx_semaphore_put_notify(TX_SEMAPHORE
            ...
            *));
```
## <a name="thread-control-services"></a>スレッド制御サービス
...
```
## <a name="time-services"></a>時間サービス

```C
ULONG     tx_time_get(VOID);
VOID      tx_time_set(ULONG new_time);
```
## <a name="timer-services"></a>タイマー サービス
